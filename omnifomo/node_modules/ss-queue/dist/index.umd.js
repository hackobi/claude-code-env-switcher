(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var SinglyList = /** @class */ (function (_super) {
        __extends$1(SinglyList, _super);
        function SinglyList() {
            var values = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                values[_i] = arguments[_i];
            }
            return _super.apply(this, __spread$1(values)) || this;
        }
        ...
        SinglyList.prototype.clone = function () {
            ...
            return new (SinglyList.bind.apply(SinglyList, __spread$1([void 0], arrValue)))();
        };
        return SinglyList;
    }(List));
    var AbstractCircleSinglyList = /** @class */ (function (_super) {
        __extends$1(AbstractCircleSinglyList, _super);
        function AbstractCircleSinglyList() {
            var values = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                values[_i] = arguments[_i];
            }
            var _this = _super.apply(this, __spread$1(values)) || this;
            _this.cyclization();
            return _this;
        }
    ...
    var CircleSinglyList = /** @class */ (function (_super) {
        __extends$1(CircleSinglyList, _super);
        ...
        CircleSinglyList.prototype.clone = function () {
            var arrValue = this.toArray();
            return new (CircleSinglyList.bind.apply(CircleSinglyList, __spread$1([void 0], arrValue)))();
        };
        return CircleSinglyList;
    }(AbstractCircleSinglyList));

    var DoublyList = /** @class */ (function (_super) {
        __extends$1(DoublyList, _super);
        function DoublyList() {
            var values = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                values[_i] = arguments[_i];
        ...
        DoublyList.prototype.clone = function () {
            var arrValue = this.toArray();
            return new (DoublyList.bind.apply(DoublyList, __spread$1([void 0], arrValue)))();
        };
        return DoublyList;
    }(List));
    var AbstractCircleDoublyList = /** @class */ (function (_super) {
        __extends$1(AbstractCircleDoublyList, _super);
    ...
    var CircleDoublyList = /** @class */ (function (_super) {
        __extends$1(CircleDoublyList, _super);
        ...
        CircleDoublyList.prototype.clone = function () {
            var arrValue = this.toArray();
            return new (CircleDoublyList.bind.apply(CircleDoublyList, __spread$1([void 0], arrValue)))();
        };
