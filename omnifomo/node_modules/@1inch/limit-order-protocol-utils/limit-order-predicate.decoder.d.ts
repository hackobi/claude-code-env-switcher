...
export declare type PredicateAstArguments = Record<string, PredicateAstNode> | Array<PredicateAstNode>;
export declare class DecodableCall {
    readonly calldata: string;
    readonly target: Address;
    constructor(calldata: string, target: Address);
}
export declare type DecodableArguments = Record<string, DecodableCall | PredicateBytes> | Array<DecodableCall | PredicateBytes>;
 ...
 * ```
 */
export declare type CallArguments = Result | {
 ...
 */
declare type Decoder = (fn: FunctionFragment, data: Required<CallArguments>, address: Address) => DecodablePredicateAstNode;
/**
 * {
 ...
 * }
 */
export declare type DecodersImplementation<Implementation> = {
    [K in keyof Implementation]: (Implementation[K] extends Function ? Decoder : Implementation[K]);
};
declare type DecodableInterfaces<T> = Record<Address, {
    iface: Interface;
    decoders: DecodersImplementation<T>;
}>;
declare type DecodableContracts<T> = Record<Address, {
    abi: ABI;
    decoders: DecodersImplementation<T>;
}>;
export declare type PredicateAstMatcher = (node: PredicateAstNode) => boolean;
export declare class LimitOrderPredicateDecoder<T extends ChainId, Decoders extends DecodersImplementation<Decoders>> {
    ...
    constructor(chainId: T, decodableContracts?: DecodableContracts<Decoders>);
