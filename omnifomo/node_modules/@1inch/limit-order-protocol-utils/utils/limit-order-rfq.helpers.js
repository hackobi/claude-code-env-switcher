...
function createOrder(params) {
    const contractAddress = limit_order_protocol_const_1.limirOrderProtocolAdresses[params.chainId];
...
function fillOrder(params, order) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const walletAddress = web3.eth.accounts.privateKeyToAccount(params.privateKey).address;
        const limitOrderBuilder = new limit_order_builder_1.LimitOrderBuilder(contractAddress, params.chainId, providerConnector);
        const limitOrderProtocolFacade = new limit_order_protocol_facade_1.LimitOrderProtocolFacade(contractAddress, params.chainId, providerConnector);
        ...
        const callData = limitOrderProtocolFacade.fillRFQOrder(order, signature, params.makingAmount, params.takingAmount);
        const txConfig = {
            to: contractAddress,
            from: walletAddress,
            data: callData,
