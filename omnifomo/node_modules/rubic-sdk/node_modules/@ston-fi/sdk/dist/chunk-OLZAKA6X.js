...
var PoolV1 = class _PoolV1 extends JettonMinter {
  ...
  async createBurnBody(params) {
    return beginCell().storeUint(DEX_OP_CODES.BURN, 32).storeUint(params?.queryId ?? 0, 64).storeCoins(BigInt(params.amount)).storeAddress(toAddress(params.responseAddress)).endCell();
  }
  /**
...
//# sourceMappingURL=chunk-OLZAKA6X.js.map