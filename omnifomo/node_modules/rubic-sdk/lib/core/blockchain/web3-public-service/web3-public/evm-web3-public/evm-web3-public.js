...
const uni_v3_permit2_abi_1 = require("./constants/uni-v3-permit2-abi");
/**
...
class EvmWeb3Public extends web3_public_1.Web3Public {
    ...
    async getAllowanceAndExpirationOnPermit2(tokenAddress, walletAddress, spenderAddress, permit2Address) {
        try {
            const contract = new this.web3.eth.Contract(uni_v3_permit2_abi_1.UNI_V3_PERMIT_2_ABI, permit2Address);
            const res = (await contract.methods['allowance'](walletAddress, tokenAddress, spenderAddress).call());
            return [new bignumber_js_1.default(res.amount), res.expiration];
        }
        catch (err) {
            console.error(err);
            return [new bignumber_js_1.default(0), '0'];
        }
    }
    ...
    async getTxDecodedLogData(hash, inputs, key) {
