...
class BlockchainsInfo {
    ...
    static isTonBlockchainName(blockchainName) {
        return blockchainName === blockchain_name_1.BLOCKCHAIN_NAME.TON;
    }
    static isSuiBlockchainName(blockchainName) {
        return blockchainName === blockchain_name_1.BLOCKCHAIN_NAME.SUI;
    }
}
