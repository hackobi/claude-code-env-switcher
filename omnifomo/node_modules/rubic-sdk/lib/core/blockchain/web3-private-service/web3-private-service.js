...
const bitcoin_web3_private_1 = require("./web3-private/bitcoin-web3-private/bitcoin-web3-private");
...
const sui_web3_private_1 = require("./web3-private/sui-web3-private/sui-web3-private");
const tron_web3_private_1 = require("./web3-private/tron-web3-private/tron-web3-private");
const web3_1 = __importDefault(require("web3"));
const ton_web3_private_1 = require("./web3-private/ton-web3-private/ton-web3-private");
class Web3PrivateService {
    ...
    constructor(walletProvider) {
        this.createWeb3Private = {
            ...
            [chain_type_1.CHAIN_TYPE.TON]: this.createTonWeb3Private.bind(this),
            [chain_type_1.CHAIN_TYPE.BITCOIN]: this.createBitcoinWeb3Private.bind(this),
            [chain_type_1.CHAIN_TYPE.SUI]: this.createSuiWeb3Private.bind(this)
        };
    ...
    createSuiWeb3Private(solanaWallet) {
        return new sui_web3_private_1.SuiWeb3Private(solanaWallet);
    }
    createTonWeb3Private(tonProviderCore) {
        return new ton_web3_private_1.TonWeb3Private(tonProviderCore);
    }
    createBitcoinWeb3Private(providerCore) {
        return new bitcoin_web3_private_1.BitcoinWeb3Private(providerCore);
    }
