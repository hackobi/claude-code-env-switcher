import { BitcoinBlockchainName, BlockchainName, EvmBlockchainName, SolanaBlockchainName, SuiBlockchainName, TonBlockchainName, TronBlockchainName } from "../models/blockchain-name";
...
export declare class Web3PrivateService {
    ...
    getWeb3Private(chainType: 'TON'): TonWeb3Private;
    getWeb3Private(chainType: 'BITCOIN'): BitcoinWeb3Private;
    getWeb3Private(chainType: 'SUI'): SuiWeb3Private;
    ...
    getWeb3PrivateByBlockchain(blockchain: TonBlockchainName): TonWeb3Private;
    getWeb3PrivateByBlockchain(blockchain: BitcoinBlockchainName): BitcoinWeb3Private;
    getWeb3PrivateByBlockchain(blockchain: SuiBlockchainName): SuiWeb3Private;
    ...
    private createSuiWeb3Private;
    private createTonWeb3Private;
    private createBitcoinWeb3Private;
