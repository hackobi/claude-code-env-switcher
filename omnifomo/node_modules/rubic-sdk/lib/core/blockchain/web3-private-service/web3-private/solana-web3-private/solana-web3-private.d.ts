...
import { SolanaWeb3Pure } from "../../../web3-pure/typed-web3-pure/solana-web3-pure/solana-web3-pure";
...
export declare class SolanaWeb3Private extends Web3Private {
    ...
    sendTransaction(options: SolanaTransactionOptions, calculateConsumedParams?: boolean): Promise<string>;
