...
class TronWeb3Private extends web3_private_1.Web3Private {
    ...
    async sendTransaction(contractAddress, methodSignature, parameters, options = {}) {
        try {
    ...
    async trySendTransaction(contractAddress, methodSignature, parameters, options = {}) {
        try {
            await this.tronWeb.transactionBuilder.estimateEnergy(contractAddress, methodSignature, {}, parameters, this.address);
        }
        catch (err) {
