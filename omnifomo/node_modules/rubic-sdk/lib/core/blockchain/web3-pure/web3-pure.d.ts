...
import { SolanaWeb3Pure } from "./typed-web3-pure/solana-web3-pure/solana-web3-pure";
import { SuiWeb3Pure } from "./typed-web3-pure/sui-web3-pure/sui-web3-pure";
import { TonWeb3Pure } from "./typed-web3-pure/ton-web3-pure/ton-web3-pure";
...
export declare class Web3Pure {
    ...
    static [CHAIN_TYPE.SUI]: typeof SuiWeb3Pure;
    /**
