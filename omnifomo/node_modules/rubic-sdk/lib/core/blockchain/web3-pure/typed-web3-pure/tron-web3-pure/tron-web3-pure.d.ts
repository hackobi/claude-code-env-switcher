...
export declare class TronWeb3Pure {
     ...
     */
    static encodeMethodCall(contractAddress: string, contractAbi: AbiItem[], methodName: string, methodArguments: TronParameters, callValue?: number, feeLimit?: number): TronTransactionConfig;
    /**
