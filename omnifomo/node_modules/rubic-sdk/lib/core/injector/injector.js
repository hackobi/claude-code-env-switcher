...
class Injector {
    ...
    static get teleSwapSdkInstance() {
        return Injector.injector.teleSwapSdk;
    }
    static createInjector(web3PublicService, web3PrivateService, httpClient, teleSwapSdk) {
        // eslint-disable-next-line no-new
        new Injector(web3PublicService, web3PrivateService, httpClient, teleSwapSdk);
    }
    constructor(web3PublicService, web3PrivateService, httpClient, teleSwapSdk) {
