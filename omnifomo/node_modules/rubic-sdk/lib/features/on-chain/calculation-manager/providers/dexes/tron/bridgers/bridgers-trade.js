...
class BridgersTrade extends tron_on_chain_trade_1.TronOnChainTrade {
    ...
    async swap(options = {}) {
        ...
        try {
            ...
            return await this.web3Private.sendTransaction(this.contractAddress, transactionData.functionName, transactionData.parameter, { ...transactionData.options, onTransactionHash: options.onConfirm });
        }
        catch (err) {
    ...
    async getTransactionData(options) {
        const fromTokenAddress = (0, token_native_address_proxy_1.createTokenNativeAddressProxy)(this.from, bridgers_native_address_1.bridgersNativeAddress, false).address;
        const toTokenAddress = (0, token_native_address_proxy_1.createTokenNativeAddressProxy)(this.to, bridgers_native_address_1.bridgersNativeAddress, false).address;
