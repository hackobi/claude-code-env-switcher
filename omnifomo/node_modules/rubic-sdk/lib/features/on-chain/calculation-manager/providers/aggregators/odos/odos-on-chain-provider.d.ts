...
export declare class OdosOnChainProvider extends AggregatorOnChainProvider {
    ...
    isSupportedBlockchain(blockchainName: BlockchainName): boolean;
    ...
    protected getGasFeeInfo(from: PriceTokenAmount<EvmBlockchainName>, gasLimit: number): Promise<GasFeeInfo | null>;
}
