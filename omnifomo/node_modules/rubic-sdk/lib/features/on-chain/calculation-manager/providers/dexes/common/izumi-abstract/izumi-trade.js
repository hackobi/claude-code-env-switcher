...
class IzumiTrade extends evm_on_chain_trade_1.EvmOnChainTrade {
    ...
    async getTransactionConfigAndAmount(options) {
        ...
        const { swapCalling, options: data } = (0, swap_1.getSwapChainWithExactInputCall)(swapContract, this.walletAddress, chain ?? chainId, swapParams, gasPriceInfo.gasPrice.toFixed());
        const config = {
