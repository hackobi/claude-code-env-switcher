...
class EvmWrapTrade extends evm_on_chain_trade_1.EvmOnChainTrade {
    ...
    async getTransactionConfigAndAmount(options) {
        ...
        const config = evm_web3_pure_1.EvmWeb3Pure.encodeMethodCall(this.dexContractAddress, wrap_abi_1.wrapAbi, methodName, this.from.isNative ? [] : [this.from.stringWeiAmount], this.from.isNative ? this.from.stringWeiAmount : '0', gasParams);
