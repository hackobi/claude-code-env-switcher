...
exports.IzumiArbitrumProvider = void 0;
const blockchain_name_1 = require("../../../../../../../core/blockchain/models/blockchain-name");
const izumi_provider_1 = require("../../common/izumi-abstract/izumi-provider");
class IzumiArbitrumProvider extends izumi_provider_1.IzumiProvider {
    constructor() {
        super(...arguments);
        this.blockchain = blockchain_name_1.BLOCKCHAIN_NAME.ARBITRUM;
        this.dexAddress = '0x01fDea353849cA29F778B2663BcaCA1D191bED0e';
        this.config = {
            maxTransitTokens: 2,
            ...
            supportedFees: [400, 2000, 10000]
        };
    }
}
exports.IzumiArbitrumProvider = IzumiArbitrumProvider;
//# sourceMappingURL=izumi-arbitrum-provider.js.map