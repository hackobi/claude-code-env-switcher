...
import { EvmEncodedConfigAndToAmount } from "../../on-chain-aggregator/models/aggregator-on-chain-types";
...
export declare abstract class EvmOnChainTrade extends OnChainTrade {
    protected lastTransactionConfig: EvmEncodeConfig | null;
     ...
     */
    readonly permit2ApproveConfig: Permit2ApproveConfig;
    ...
    getData(fromAddress: string, options?: SwapTransactionOptions): Promise<EvmTransactionOptions | never>;
    ...
    protected abstract getTransactionConfigAndAmount(options: EncodeTransactionOptions): Promise<EvmEncodedConfigAndToAmount>;
    protected setTransactionConfig(options: EncodeTransactionOptions): Promise<EvmEncodeConfig>;
    protected getSwapError(err: Error & {
        code: number;
    }): Error;
}
