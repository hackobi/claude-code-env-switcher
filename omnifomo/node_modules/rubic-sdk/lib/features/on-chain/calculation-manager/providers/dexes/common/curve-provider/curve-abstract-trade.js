...
class CurveAbstractTrade extends evm_on_chain_trade_1.EvmOnChainTrade {
    ...
    async getTransactionConfigAndAmount(options) {
        ...
        const config = evm_web3_pure_1.EvmWeb3Pure.encodeMethodCall(this.dexContractAddress, registry_exchange_abi_1.registryExchangeAbi, 'exchange', exchangeParams, this.nativeValueToSend, gasParams);
