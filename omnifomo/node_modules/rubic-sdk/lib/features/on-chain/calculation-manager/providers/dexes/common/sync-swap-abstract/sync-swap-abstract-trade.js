...
const constants_1 = require("../../../aggregators/1inch/constants/constants");
...
class SyncSwapAbstractTrade extends evm_on_chain_trade_1.EvmOnChainTrade {
    ...
    async getTransactionConfigAndAmount(options) {
        ...
        const config = evm_web3_pure_1.EvmWeb3Pure.encodeMethodCall(this.dexContractAddress, sync_swap_abi_1.syncSwapAbi, 'swap', params, value, gasParams);
