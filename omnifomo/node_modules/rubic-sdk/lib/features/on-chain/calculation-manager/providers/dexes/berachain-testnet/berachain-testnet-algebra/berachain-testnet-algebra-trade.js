...
exports.BerachainTestnetAlgebraTrade = void 0;
...
class BerachainTestnetAlgebraTrade extends uniswap_v3_algebra_abstract_trade_1.UniswapV3AlgebraAbstractTrade {
    static get type() {
        return on_chain_trade_type_1.ON_CHAIN_TRADE_TYPE.ALGEBRA;
    }
    constructor(tradeStruct, providerAddress) {
        super(tradeStruct, providerAddress);
        this.dexContractAddress = swap_router_contract_data_1.BERACHAIN_TESTNET_ALGEBRA_ROUTER_CONTRACT_ADDRESS;
        this.contractAbi = swap_router_contract_data_1.BERACHAIN_TESTNET_ALGEBRA_ROUTER_CONTRACT_ABI;
...
exports.BerachainTestnetAlgebraTrade = BerachainTestnetAlgebraTrade;
//# sourceMappingURL=berachain-testnet-algebra-trade.js.map