...
class UniswapV2AbstractProvider extends evm_on_chain_provider_1.EvmOnChainProvider {
    ...
    async calculateDifficultTrade(fromToken, toToken, weiAmount, exact, options) {
        ...
        const { route } = await this.getAmountAndPath(fromProxy, toProxy, weiAmountWithoutFee, exact, fullOptions, proxyFeeInfo);
    ...
    async getAmountAndPath(from, to, weiAmount, exact, options, proxyFeeInfo) {
