...
exports.UNI_SWAP_V3_SPARK_DEX_FLARE_ROUTER_CONFIGURATION = void 0;
...
const routerTokens = {
    WFLR: wrapped_native_tokens_1.wrappedNativeTokensList[blockchain_name_1.BLOCKCHAIN_NAME.FLARE].address,
...
exports.UNI_SWAP_V3_SPARK_DEX_FLARE_ROUTER_CONFIGURATION = {
    tokens: routerTokens,
    liquidityPools: routerLiquidityPools
};
//# sourceMappingURL=spark-dex-v3-flare-router-config.js.map