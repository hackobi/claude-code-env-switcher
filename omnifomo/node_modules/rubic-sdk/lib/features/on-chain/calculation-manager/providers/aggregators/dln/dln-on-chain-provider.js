...
const debridge_code_1 = require("../../../../../cross-chain/calculation-manager/providers/debridge-provider/constants/debridge-code");
...
class DlnOnChainProvider extends aggregator_on_chain_provider_abstract_1.AggregatorOnChainProvider {
    ...
    getAffiliateFee(from) {
        if (from.blockchain === blockchain_name_1.BLOCKCHAIN_NAME.SOLANA) {
            const feePercent = (0, get_solana_fee_1.getSolanaFee)(from);
            if (feePercent) {
                return {
                    affiliateFeeRecipient: '6pvJfh73w1HT3b9eKRMX3EfrKH5AihVqRhasyhN5qtfP',
                    affiliateFeePercent: new bignumber_js_1.default(100).multipliedBy(feePercent).toNumber()
                };
            }
        }
        return {};
