...
const evm_common_cross_chain_abi_1 = require("../../../../../cross-chain/calculation-manager/providers/common/evm-cross-chain-trade/constants/evm-common-cross-chain-abi");
class OnChainProxyService {
    static isSupportedBlockchain(blockchain) {
        const isProxySupported = proxy_supported_blockchain_1.proxySupportedBlockchains.some(supportedBlockchain => supportedBlockchain === blockchain &&
            !proxy_supported_blockchain_1.ON_CHAIN_PROXY_DISABLED_CHAINS.some(chain => chain === blockchain));
