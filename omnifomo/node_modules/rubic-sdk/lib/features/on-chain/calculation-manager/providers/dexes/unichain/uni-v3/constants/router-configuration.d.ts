 ...
 */
declare const tokensSymbols: readonly ["PI", "WETH", "USDC", "UNI", "UNICORN", "UNIDOGE", "1$", "TINY"];
type TokenSymbol = (typeof tokensSymbols)[number];
export declare const UNI_SWAP_V3_UNICHAIN_ROUTER_CONFIGURATION: UniswapV3RouterConfiguration<TokenSymbol>;
export {};
