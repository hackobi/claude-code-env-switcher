...
exports.defaultSoneiumProviderConfiguration = void 0;
...
const defaultSoneiumRoutingProvidersAddresses = [
    wrapped_native_tokens_1.wrappedNativeTokensList[blockchain_name_1.BLOCKCHAIN_NAME.SONEIUM].address, // WETH
...
const defaultSoneiumWethAddress = wrapped_native_tokens_1.wrappedNativeTokensList[blockchain_name_1.BLOCKCHAIN_NAME.SONEIUM].address;
exports.defaultSoneiumProviderConfiguration = {
    maxTransitTokens: 1,
