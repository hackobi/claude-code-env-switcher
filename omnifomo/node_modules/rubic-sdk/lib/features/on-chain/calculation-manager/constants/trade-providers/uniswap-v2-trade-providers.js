...
const macaron_provider_1 = require("../../providers/dexes/bitlayer/macaron/macaron-provider");
const uni_swap_v2_blast_provider_1 = require("../../providers/dexes/blast/uni-swap-v2-blast/uni-swap-v2-blast-provider");
...
const ascent_horizen_eon_provider_1 = require("../../providers/dexes/horizen-eon/ascent-horizon-eon/ascent-horizen-eon-provider");
const spooky_swap_horizen_eon_provider_1 = require("../../providers/dexes/horizen-eon/spooky-swap-horizen-eon/spooky-swap-horizen-eon-provider");
...
const eddy_finance_mode_provider_1 = require("../../providers/dexes/mode/eddy-finance-mode/eddy-finance-mode-provider");
...
const bulbaswap_provider_1 = require("../../providers/dexes/morph/bulbaswap/bulbaswap-provider");
...
const dragonswap_provider_1 = require("../../providers/dexes/sei/dragonswap/dragonswap-provider");
...
const eddy_finance_provider_1 = require("../../providers/dexes/zetachain/eddy-finance/eddy-finance-provider");
const mute_swap_provider_1 = require("../../providers/dexes/zksync/mute-swap/mute-swap-provider");
const kujata_bahamut_provider_1 = require("../../providers/dexes/bahamut/kujata-bahamut/kujata-bahamut-provider");
const silk_swap_bahamut_provider_1 = require("../../providers/dexes/bahamut/silk-swap-bahamut/silk-swap-bahamut-provider");
const blaze_swap_flare_provider_1 = require("../../providers/dexes/flare/blaze-swap-flare/blaze-swap-flare-provider");
const enosys_flare_provider_1 = require("../../providers/dexes/flare/enosys-flare/enosys-v2-flare/enosys-flare-provider");
const spark_dex_flare_provider_1 = require("../../providers/dexes/flare/spark-dex-flare/spark-dex-v2-flare/spark-dex-flare-provider");
const frax_swap_v2_provider_1 = require("../../providers/dexes/fraxtal/frax-swap-v2/frax-swap-v2-provider");
const kyo_finance_provider_1 = require("../../providers/dexes/soneium/kyo-finance/kyo-finance-provider");
const sushi_swap_zetachain_provider_1 = require("../../providers/dexes/zetachain/sushi-swap-zetachain/sushi-swap-zetachain-provider");
exports.UniswapV2TradeProviders = [
    ...
    // horizen eon
    spooky_swap_horizen_eon_provider_1.SpookySwapHorizenEonProvider,
    ascent_horizen_eon_provider_1.AscentHorizenEonProvider,
    // Blast
    uni_swap_v2_blast_provider_1.UniSwapV2BlastProvider,
    // ZetaChain
    eddy_finance_provider_1.EddyFinanceProvider,
    sushi_swap_zetachain_provider_1.SushiSwapZetachainProvider,
    // Mode
    eddy_finance_mode_provider_1.EddyFinanceModeProvider,
    // Sei
    dragonswap_provider_1.DragonSwapProvider,
    //Bahamut
    silk_swap_bahamut_provider_1.SilkSwapBahamutProvider,
    kujata_bahamut_provider_1.KujataBahamutProvider,
    // Bitlayer
    macaron_provider_1.MacaronProvider,
    // Flare
    blaze_swap_flare_provider_1.BlazeSwapFlareProvider,
    spark_dex_flare_provider_1.SparkDexFlareProvider,
    enosys_flare_provider_1.EnosysFlareProvider,
    // Morph
    bulbaswap_provider_1.BulbaswapProvider,
    // Fraxtal
    frax_swap_v2_provider_1.FraxSwapV2Provider,
    // Soneium
    kyo_finance_provider_1.KyoFinanceProvider
];
