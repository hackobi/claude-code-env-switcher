...
class OnChainStatusManager {
    ...
    static async getBitcoinTransaction(srcTxHash) {
        return this.getSrcStatusRecursive(srcTxHash, blockchain_name_1.BLOCKCHAIN_NAME.BITCOIN, 300000);
    }
    static async getSrcStatusRecursive(srcTxHash, blockchain, timeoutMs) {
        const srcTxStatus = await (0, get_src_tx_status_1.getSrcTxStatus)(blockchain, srcTxHash);
        ...
        await (0, waitFor_1.waitFor)(timeoutMs);
