...
class RangoUtils {
    ...
    static getTradeTypeForRubic(rangoTradeType, type) {
        if (type === 'cross-chain') {
            return rango_api_trade_types_1.RANGO_TO_RUBIC_PROVIDERS[rangoTradeType] || cross_chain_trade_type_1.CROSS_CHAIN_TRADE_TYPE.RANGO;
        }
        return rango_api_trade_types_1.RANGO_TO_RUBIC_PROVIDERS[rangoTradeType] || on_chain_trade_type_1.ON_CHAIN_TRADE_TYPE.RANGO;
    }
}
