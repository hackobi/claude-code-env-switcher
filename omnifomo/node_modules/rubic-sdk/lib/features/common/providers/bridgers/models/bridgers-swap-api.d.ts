...
import { TonBridgersTransactionData } from "../../../../cross-chain/calculation-manager/providers/bridgers-provider/models/ton-bridgers-transaction-data";
...
export interface BridgersSwapResponse<T extends EvmBridgersTransactionData | TronBridgersTransactionData | TonBridgersTransactionData> {
    data: {
        txData: T;
    };
    resCode: number;
