...
const rango_cross_chain_factory_1 = require("./rango-cross-chain-factory");
...
class RangoCrossChainProvider extends cross_chain_provider_1.CrossChainProvider {
    ...
    async calculate(from, toToken, options) {
        ...
        try {
            ...
            const trade = rango_cross_chain_factory_1.RangoCrossChainFactory.createTrade(fromBlockchain, tradeParams);
    ...
    async getStep(rangoPath) {
        ...
        const provider = rango_utils_1.RangoUtils.getTradeTypeForRubic(rangoPath.swapper.swapperGroup, type);
    ...
    getReceiverAddress(blockchain) {
        ...
        if (type === chain_type_1.CHAIN_TYPE.BITCOIN) {
            return fake_wallet_address_1.FAKE_BITCOIN_ADDRESS;
        }
