...
class ChangeNowCrossChainApiService {
    ...
    static async getTxStatus(changenowId) {
        const res = await injector_1.Injector.httpClient.get(`${ChangeNowCrossChainApiService.changenowApiEndpoint}/exchange/by-id`, {
