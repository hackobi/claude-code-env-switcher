...
exports.UNIQ_LIFI_BRIDGE_TYPES = {
    ...
    CBRIDGE: lifi_bridge_types_1.LIFI_API_CROSS_CHAIN_PROVIDERS.CBRIDGE,
    ...
    ALLBRIDGE: lifi_bridge_types_1.LIFI_API_CROSS_CHAIN_PROVIDERS.ALLBRIDGE,
    POLYGON_BRIDGE: default_bridge_type_1.DEFAULT_BRIDGE_TYPE.POLYGON,
    OMNI_BRIDGE: lifi_bridge_types_1.LIFI_API_CROSS_CHAIN_PROVIDERS.OMNI_BRIDGE,
    GNOSIS_BRIDGE: lifi_bridge_types_1.LIFI_API_CROSS_CHAIN_PROVIDERS.GNOSIS_BRIDGE,
    CONNEXT_AMAROK: lifi_bridge_types_1.LIFI_API_CROSS_CHAIN_PROVIDERS.CONNEXT_AMAROK,
    CIRCLE_CELER_BRIDGE: lifi_bridge_types_1.LIFI_API_CROSS_CHAIN_PROVIDERS.CIRCLE_CELER_BRIDGE,
    LI_FUEL: default_bridge_type_1.DEFAULT_BRIDGE_TYPE.LI_FUEL,
