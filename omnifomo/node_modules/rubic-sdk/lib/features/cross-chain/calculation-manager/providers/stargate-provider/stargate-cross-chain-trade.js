...
class StargateCrossChainTrade extends evm_cross_chain_trade_1.EvmCrossChainTrade {
    ...
    async getTransactionConfigAndAmount(receiverAddress) {
        ...
        const config = await StargateCrossChainTrade.getLayerZeroSwapData(fromToken, this.to, web3_pure_1.Web3Pure.toWei(this.toTokenAmountMin, this.to.decimals), receiverAddress);
    ...
    async getContractParams(options) {
        ...
        const dstSwapConfiguration = undefined;
        ...
        //     );
        // }
        const providerData = this.getProviderData(data, dstSwapConfiguration, options.receiverAddress);
