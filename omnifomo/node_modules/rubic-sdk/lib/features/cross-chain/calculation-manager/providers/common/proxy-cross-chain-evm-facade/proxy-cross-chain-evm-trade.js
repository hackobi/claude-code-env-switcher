...
const evm_common_cross_chain_abi_1 = require("../evm-cross-chain-trade/constants/evm-common-cross-chain-abi");
...
const constants_1 = require("../../../../../on-chain/calculation-manager/providers/aggregators/1inch/constants/constants");
const assert_evm_token_1 = require("../../../../../on-chain/calculation-manager/utils/assert-evm-token");
...
class ProxyCrossChainEvmTrade {
    ...
    static getReceiverAddress(receiverAddress, walletAddress, toChainId) {
        if (toChainId === blockchain_id_1.blockchainId[blockchain_name_1.BLOCKCHAIN_NAME.BITCOIN] ||
            ...
            toChainId === blockchain_id_1.blockchainId[blockchain_name_1.BLOCKCHAIN_NAME.TON] ||
            toChainId === blockchain_id_1.blockchainId[blockchain_name_1.BLOCKCHAIN_NAME.SUI]) {
