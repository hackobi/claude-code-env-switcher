...
export declare abstract class CrossChainTrade<T = unknown> {
    ...
    private _apiFromAddress;
    set apiFromAddress(value: string | null);
    protected constructor(providerAddress: string, routePath: RubicStep[], useProxy: boolean);
    /**
    ...
    checkBlockchainRequirements(): Promise<boolean>;
    ...
    protected abstract getTransactionConfigAndAmount(receiverAddress?: string, refundAddress?: string): Promise<{
        config: T;
        amount: string;
    }>;
    protected setTransactionConfig(skipAmountChangeCheck: boolean, useCacheData: boolean, receiverAddress?: string, refundAddress?: string): Promise<T>;
}
