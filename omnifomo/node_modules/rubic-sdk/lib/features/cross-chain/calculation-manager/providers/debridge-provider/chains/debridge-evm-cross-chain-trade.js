...
const debridge_code_1 = require("../constants/debridge-code");
/**
...
class DebridgeEvmCrossChainTrade extends evm_cross_chain_trade_1.EvmCrossChainTrade {
    ...
    async getContractParams(options) {
        ...
        const providerData = await proxy_cross_chain_evm_trade_1.ProxyCrossChainEvmTrade.getGenericProviderData(to, data, this.fromBlockchain, this.allowanceTarget, extraNativeFee);
    ...
    async getTransactionConfigAndAmount(receiverAddress) {
        ...
        const params = {
            ...
            srcChainOrderAuthorityAddress: sameChain
                ? receiverAddress || walletAddress
                : walletAddress,
            referralCode: debridge_code_1.deBridgeReferralCode
        };
        const { tx, estimation } = await dln_api_service_1.DlnApiService.fetchCrossChainSwapData(params);
        const toAmount = new bignumber_js_1.default(estimation.dstChainTokenOut.maxTheoreticalAmount);
