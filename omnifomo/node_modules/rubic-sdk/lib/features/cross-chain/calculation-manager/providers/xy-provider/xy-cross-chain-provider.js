...
class XyCrossChainProvider extends cross_chain_provider_1.CrossChainProvider {
    ...
    async calculate(fromToken, toToken, options) {
        ...
        try {
            ...
            const requestParams = {
                ...
                bridgeProviders: 'yBridge,XassetBridge,Synapse,Across,Owlto,PolygonPoSEtherBridge,ArbitrumEtherBridge'
            };
            ...
            const { srcSwapDescription, bridgeDescription, dstSwapDescription, dstQuoteTokenAmount, estimatedGasFeeAmount } = routes[0];
            ...
            const bridgeType = (bridgeDescription.provider === 'yBridge' ? bridge_type_1.BRIDGE_TYPE.YPOOL : bridge_type_1.BRIDGE_TYPE.XY);
            return {
                trade: new xy_cross_chain_trade_1.XyCrossChainTrade({
                    ...
                    xyEstimatedGas: new bignumber_js_1.default(estimatedGasFeeAmount)
    ...
    async getRoutePath(fromToken, toToken, quote) {
        ...
        if (transitFromAddress) {
            routePath.push({
                type: 'on-chain',
                provider: on_chain_trade_type_1.ON_CHAIN_TRADE_TYPE.XY_DEX,
