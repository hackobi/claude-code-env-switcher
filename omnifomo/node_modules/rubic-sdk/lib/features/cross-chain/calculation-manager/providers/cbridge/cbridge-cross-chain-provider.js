...
class CbridgeCrossChainProvider extends cross_chain_provider_1.CrossChainProvider {
    ...
    async calculate(fromToken, toToken, options) {
        ...
        try {
            ...
            const toAmount = new bignumber_js_1.default(amount).lt(0) ? 0 : amount;
            const to = new tokens_1.PriceTokenAmount({
                ...toToken.asStruct,
                tokenAmount: web3_pure_1.Web3Pure.fromWei(toAmount, toToken.decimals)
            });
            ...
            return {
                trade: new cbridge_cross_chain_trade_1.CbridgeCrossChainTrade({
                    ...
                    transitMinAmount,
                    onChainTrade
                }, options.providerAddress, await this.getRoutePath(fromToken, transitToken, to, onChainTrade), useProxy),
                error: amountsErrors,
                tradeType: this.type
            };
        }
