...
const custom_deflation_token_list_1 = require("./models/custom-deflation-token-list");
...
class DeflationTokenManager {
    ...
    async isDeflationToken(token) {
        ...
        const deflationTokenList = custom_deflation_token_list_1.customDeflationTokenList[evmToken.blockchain];
        if (deflationTokenList &&
            deflationTokenList.some(tokenAddress => (0, blockchain_1.compareAddresses)(tokenAddress, evmToken.address))) {
            return { isDeflation: true, isWhitelisted: true, percent: new bignumber_js_1.default(0) };
        }
