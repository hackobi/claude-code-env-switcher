...
exports.scaleFromNativeTokenDecimalsTo18Decimals = exports.scaleFrom18DecimalsToNativeTokenDecimals = exports.getNativeTokenDecimals = exports.getBlockRangesForL1Block = exports.getFirstBlockForL1Block = exports.isArbitrumChain = exports.isDefined = exports.getTransactionReceipt = exports.getBaseFee = exports.wait = void 0;
...
async function getNativeTokenDecimals({ l1Provider, l2Network, }) {
    const nativeTokenAddress = l2Network.nativeToken;
    if (!nativeTokenAddress || nativeTokenAddress === ethers_1.constants.AddressZero) {
        return 18;
    }
    const nativeTokenContract = ERC20__factory_1.ERC20__factory.connect(nativeTokenAddress, l1Provider);
    try {
