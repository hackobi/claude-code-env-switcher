...
class EthBridger extends assetBridger_1.AssetBridger {
    ...
    async depositTo(params) {
        ...
        const l1ToL2MessageCreator = new L1ToL2MessageCreator_1.L1ToL2MessageCreator(params.l1Signer);
        const tx = await l1ToL2MessageCreator.createRetryableTicket(retryableTicketRequest, params.l2Provider);
