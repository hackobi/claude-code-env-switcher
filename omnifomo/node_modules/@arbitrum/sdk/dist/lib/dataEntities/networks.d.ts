 ...
 */
export declare const getParentForNetwork: (chain: L1Network | L2Network) => L2Network | L1Network;
/**
 ...
 */
export declare const getNetwork: (signerOrProviderOrChainID: SignerOrProvider | number, layer: 1 | 2) => Promise<L2Network | L1Network>;
/**
...
export declare function isL2NetworkNativeTokenEther(network: L2Network): boolean;
