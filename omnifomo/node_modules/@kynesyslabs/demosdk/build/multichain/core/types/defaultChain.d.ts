...
import { IBCConnectWalletOptions, IPayParams, SolanaReadAccountDataOptions, XmTransactionResponse } from "./interfaces";
export declare abstract class DefaultChain {
     ...
     */
    prepareTransfer<T extends DefaultChain, Options extends Parameters<T["preparePays"]>[1]>(this: T, receiver: string, amount: string, options?: Options): Promise<Awaited<ReturnType<T["preparePays"]>>[number]>;
    /**
     ...
     */
    prepareTransfers<T extends DefaultChain, Options extends Parameters<T["preparePays"]>[1]>(this: T, payments: IPayParams[], options?: Options): Promise<Awaited<ReturnType<T["preparePays"]>>>;
    /**
     ...
     */
    abstract connectWallet(privateKey: string, options?: {}): Promise<this["wallet"]>;
    /**
     ...
     */
    abstract preparePay<T extends DefaultChain>(this: T, receiver: string, amount: string, options?: any): Promise<Awaited<ReturnType<T["preparePays"]>>[number]>;
    /**
     ...
     * @returns The signed transaction
     */
    abstract signTransaction<T extends DefaultChain, Tx extends Parameters<T["signTransactions"]>[0][number]>(this: T, tx: Tx, options?: any): Promise<Awaited<ReturnType<T["preparePays"]>>[number]>;
    /**
