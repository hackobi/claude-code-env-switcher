...
export declare const createMixedRouteOnChainQuoteProvider: ({ onChainProvider, multicallConfigs: multicallConfigsOverride, }: ProviderConfig) => QuoteProvider;
export declare const createV3OnChainQuoteProvider: ({ onChainProvider, multicallConfigs: multicallConfigsOverride, }: ProviderConfig) => QuoteProvider;
export {};
